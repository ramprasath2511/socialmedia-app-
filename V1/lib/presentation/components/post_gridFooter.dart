...
class PostGridFooter extends StatefulWidget {
  final Feed feed;

  const PostGridFooter({
    Key key,
    @required this.feed,
  }) : super(key: key);
  @override
  _PostGridFooterState createState() => _PostGridFooterState();
}

class _PostGridFooterState extends State<PostGridFooter> {
  bool _liked;
  int _likes;
  int _comments;
